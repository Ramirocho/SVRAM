...
public class FrmIngreso extends javax.swing.JInternalFrame {
        ...
        modeloDetalles = new DefaultTableModel(){
            ...
            public Object getValueAt(int row, int col) {
                if (col==5){
                    int cantD;
                    try {
                        cantD=Integer.parseInt((String)getValueAt(row, 3));
                    } catch (Exception e) {
                        cantD=1;
                    }
                    int  precioD=Integer.parseInt((String)getValueAt(row, 4));
                    if (cantD!=0 && precioD!=0){
                        return String.format("%d",cantD*precioD);
                    }else{
                        return 0;
                    }
                }
    ...
    private void calcularTotales(){
        ...
        if (items==0){
            ...
            for (int i = 0; i < items; i++) {
                total=total+Integer.parseInt(String.valueOf(modeloDetalles.getValueAt(i, 5)));
            }
        }
    ...
    private void initComponents() {
        ...
        cboTipoComprobante.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BOLETA", "FACTURA", "GUIA" }));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String resp="";
        resp=this.CONTROL.insertar(Integer.parseInt(txtIdProveedor.getText()),(String)cboTipoComprobante.getSelectedItem(),txtSerieComprobante.getText(),txtNumComprobante.getText(),Integer.parseInt(txtImpuesto.getText()),Integer.parseInt(txtTotal.getText()),modeloDetalles);
        if (resp.equals("OK")) {
        ...
        if (txtCodigo.getText().length()>0){
            if (evt.getKeyCode()==KeyEvent.VK_ENTER){
                ...
                if (art==null){
                    ...
                    this.agregarDetalles(Integer.toString(art.getId()),art.getCodigo(),art.getNombre(),Integer.toString(art.getPrecioVenta()));
                }
            }
